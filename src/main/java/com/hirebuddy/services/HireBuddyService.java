...
public interface HireBuddyService<Long,E> {
    ...
    public void save(E entity) throws HireBuddyException;
    public E update(E entity) throws HireBuddyException;
    public E saveOrUpdate(E entity) throws HireBuddyException;
    
    /**
     * Will throw an exception if entity to be deleted is not found.
     * @param id
     * @throws HireBuddyException
     */
